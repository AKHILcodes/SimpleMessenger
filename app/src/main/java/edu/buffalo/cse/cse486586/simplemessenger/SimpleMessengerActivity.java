...
public class SimpleMessengerActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
             ...
             */
            //AsyncTask.executeOnExecutor creates an AsyncTask & schedules it in background, will start some time later
            //AsyncTask.THREAD_POOL_EXECUTOR whenever you create a new AsyncTask with same parameter then that task and this ServerTask will run in parallel
            //AsyncTask.SERIAL_POOL_EXECUTOR instead of parallel now run serially
            // Irrespective of AsyncTask.THREAD_POOL_EXECUTOR & AsyncTask.SERIAL_POOL_EXECUTOR AsyncTask will run in parallel to main thread
